...
export const Hero = () => {
  return (
    <section className="min-h-screen flex items-center bg-background pt-16 sm:pt-20 pb-8 sm:pb-12">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-10 lg:gap-16">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row flex-wrap justify-center lg:justify-start gap-3">
              ...
              <a
                href="/Seabata_Enoch_Lebabo_Resume.pdf"
                download="Seabata_Enoch_Lebabo_Resume.pdf"
